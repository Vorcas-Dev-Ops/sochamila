...
export default function Navbar() {
  ...
  return (
    <>
      {/* ================= ANNOUNCEMENT ================= */}
      <div className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 text-white text-center py-2 text-sm font-semibold tracking-wide">
      ...
      <nav className="w-full bg-white px-5 py-4 flex items-center justify-between sticky top-0 z-50 shadow-md backdrop-blur">
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <Link
            ...
            bg-[length:200%_200%] hover:bg-[position:100%_50%]
